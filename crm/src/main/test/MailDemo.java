...
public class MailDemo {
    ...
    // 登录邮箱的账号:如我的 "123456789@qq.com"，这里改成你自己的
    private final static String loginAccount = "383641115@qq.com";
    // 登录邮箱时候需要的授权码:可以进入邮箱,账号设置那里"生成授权码"，这里改成你自己的
    private final static String loginAuthCode = "aclmkifyjzklbifh";
    // 发件人，发件人的邮箱，跟上面那个一样就可以了
    private final static String sender = "383641115@qq.com";

    /**
     * 发送邮件工具类:通过qq邮件发送,因为具有ssl加密,采用的是smtp协议
     *
     * @param receiverAddresses 收件人:支持群发
     * @param emailSubject      邮件的主题
     * @param emailContent      邮件的内容
     * @param emailContentType  邮件内容的类型,支持纯文本:"text/plain;charset=utf-8";,带有Html格式的内容:
     *                          "text/html;charset=utf-8"
     * @return res
     * 发送条数
     */
    public static int sendEmail(String[] receiverAddresses,String filename, String emailSubject, String emailContent, String emailContentType) {
        int res = 0;
    ...
    public static void main(String[] args) throws Exception {
        int res = sendEmail(new String[]{"383641115@qq.com", "1661641825@qq.com"},//这里可以发送至任何邮箱
                "out.xls",
                "测试邮件",
